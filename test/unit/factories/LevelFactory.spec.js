describe('LevelFactory', function(){
  ...
  beforeEach(inject(function(LevelFactory) {
    level = new LevelFactory({id: 1, number: 1, text:"Hiya there buddy 33", target: "\\d.", mission: "This is your mission", keystrokelimit: 50, hint: 'Work harder mate', hintDisplayed: false});
  }));
  ...
  it('has the hint displayed', function(){
    expect(level.hintDisplayed).toEqual(false);
  });
